...
public class ppt35_2 {
	static ArrayList<ppt35_1> aor = new ArrayList<ppt35_1>();
	...
	// 전체 학생의 수 만큼 반복하여 aor ArrayList 에 차례대로 Random 값을 넣는다.
		for ( int i = 0 ; i < ip ; i++){
			...
			aor.add(new ppt35_1(i,name,kor,eng,mat));
	...
	public static void itemprint(int i){
		ppt35_1 rec; // ppt33_1 타입을 가지는 rec 변수 생성, rec는 ppt33_1 사용 가능
